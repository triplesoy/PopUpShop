...
pendejos.each do |first_name, last_name|
  ...
  venue_2.photos.attach(io: venue_1_file, filename: "#{pendejito.first_name} Beautiful restaurant in the heart of Mexico", content_type: 'image/avif')
  venue_2.save!
  ...
  venue_3.photos.attach(io: venue_1_file, filename: "#{pendejito.first_name} Remodeld night club in a vibrant town", content_type: 'image/avif')
  venue_3.save!
  ...
  venue_4.photos.attach(io: venue_1_file, filename: "#{pendejito.first_name} Large store in Mexico City", content_type: 'image/avif')
  venue_4.save!
  ...
  venue_4_file = URI.open("https://www.therooftopguide.com/rooftop-bars-in-mexico-city/Bilder/cityzen-600-1.jpg")
  venue_4.photos.attach(io: venue_1_file, filename: "#{pendejito.first_name} Amazing rooftop with views", content_type: 'image/avif')
  venue_4.save!
